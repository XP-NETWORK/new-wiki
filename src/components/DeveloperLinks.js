    ...
    <section className="deveLinkContainer">
      <div className="container">
        <div className="devlinkCont">
          ...
          <p>
            The XP.NETWORK codebase is comprised of an ecosystem of open source
            components.
          </p>
        </div>
            ...
            <div className="row">
              <div className="col col--6">
                <div className="inpCol">
                  <a href="/docs/API/usage" className="links">
                    <label htmlFor="inp-1">
                      <img src="/static/img/new/icons/git.svg" />
                    </label>
                    JavaScript API
                  </a>
                </div>
              ...
              <div className="col col--6">
                <div className="inpCol">
                  <a
                    href="https://github.com/XP-NETWORK/staking-ui"
                    className="links"
                  >
                    <label htmlFor="inp-5">
                      <img src="/static/img/new/icons/git.svg" />
              ...
              <div className="col col--6">
                <div className="inpCol">
                  <a
                    href="https://github.com/xp-network/staker"
                    className="links"
                  >
                    <label htmlFor="inp-6">
                      <img src="/static/img/new/icons/git.svg" />
